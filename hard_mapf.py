...
class HighNode():
    def __init__(
        ...
        self.config: tuple[tuple[int, int], ...] = config
        self.order: tuple[int, ...] = order
        self.tree: deque[ConstraintNode] = tree
        self.parent: HighNode | None = parent


def get_new_config(node: HighNode, constraint: ConstraintNode, goals: tuple[tuple[int, int]], maze: Maze) -> tuple[tuple[int, int], ...] | None:
    ...
    def assign(agent_index: int) -> tuple[tuple[int, int], ...] | None:
...
def backtrack_high_nodes(goal_node: HighNode) -> list[tuple[tuple[int, int], ...]]:
...
def solve_hard_mapf_instance(starts: tuple[tuple[int, int]], goals: tuple[tuple[int, int]], maze: Maze) -> list[list[tuple[int, int]]]:
    ...
    explored: dict[tuple[tuple[int, int], ...], HighNode] = {starts: initial_node}
    ...
    while len(open) != 0:
        ...
        new_config: tuple[tuple[int, int], ...] = successor
